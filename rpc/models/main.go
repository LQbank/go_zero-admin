...
func main() {
	config := getConf()
	// dsn := "root:root@(localhost:3306)/go-zero?charset=utf8&parseTime=True&loc=Local"
...
func getDsn(mysql Mysql) string {
	// panic("unimplemented")
	return mysql.Username + ":" + mysql.Password + "@(" + mysql.IP + ":" + mysql.Port + ")/" + mysql.Database + "?charset=utf8mb4&parseTime=True&loc=Local"
}
